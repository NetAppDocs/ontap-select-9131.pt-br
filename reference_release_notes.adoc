...
Pode aceder ao https://library.netapp.com/ecm/ecm_download_file/ECMLP2885795["Notas de versão do ONTAP Select 9.13.1"^] para visualizar os detalhes sobre a versão atual.
